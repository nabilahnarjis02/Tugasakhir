    ...
    <form action="{{ route('produks.update',$post->id) }}" method="POST">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <input type="string" name="kode_barang" class="form-control" placeholder="Kode Barang">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Rasa:</strong>
                <input type="text" name="rasa" class="form-control" placeholder="Rasa">
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Jumlah Barang</strong>
                <input type="string" name="jumlah_barang" class="form-control" placeholder="Jumlah Barang">
            </div>
        </div>
